...
public class CardsGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_cardgame);
        toolbar.setTitle("Jogo das cartas");
            ...
            alertDialogBuilder.setMessage("Fim do jogo\nPontuação jogador 1: " + playerPoints + "\nPontuação jogador 2: "+cpuPoints).
                    ...
                    .setPositiveButton("Novo Jogo", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(getApplicationContext(), CardsGameActivity.class);
